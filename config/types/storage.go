...
// LocalStorageConfig 本地文件系统存储子配置（对应 local.Config，导入路径 storage/provider/local）。
...
// AliyunOSSConfig 阿里云 OSS 存储子配置（对应 aliyunoss.Config，导入路径 storage/provider/aliyunoss）。
